// Seed script to populate sample stories
// Run: npx ts-node --compiler-options '{"module":"CommonJS"}' scripts/seed-stories.ts
// Or add to package.json: "seed": "ts-node scripts/seed-stories.ts"
...
// Story schema (inline to avoid import issues)
...
const sampleStories = [
    {
        ...
        tags: ["science-fiction", "space", "adventure", "humanity", "first-contact"],
    },
    {
        ...
        "That's wonderful, Mom. Are they from the seniors' center?"

        Margaret glanced out at her garden, where the sunflowers were having an animated debate about the weather. "Something like that, dear. Something like that."`,
        tags: ["fantasy", "magical-realism", "elderly", "gardens", "humor", "heartwarming"],
    },
    {
        title: "Code Red",
        ...
        Maya typed faster.`,
        tags: ["thriller", "technology", "cybersecurity", "redemption", "action"],
    },
    {
        ...
        Now I make Rosa's lasagna every Sunday. My family is small—just me and my daughter—but around our kitchen table, I can still hear Grandma's laugh and feel her hand guiding mine.

        Extra cheese. Always extra cheese.`,
        tags: ["family", "food", "memories", "grief", "love", "heartwarming", "cooking"],
    },
    {
        ...
        The Egyptians exhibits were singing.
        ...
        That night, Marcus traveled through time. He witnessed the construction of pyramids, the coronation of kings, the simple joys of ancient farmers along the Nile.

        When dawn broke and the night shift ended, Marcus walked out into the New York morning with tears streaming down his weathered face.

        He'd return tomorrow night. They would be waiting.`,
        tags: ["supernatural", "museum", "history", "ancient-egypt", "mystery", "magical-realism"],
    },
    {
        ...
        I'm sorry I didn't visit more those last years. Work seemed so important then. Now I can't remember a single meeting, but I remember every Sunday breakfast you made, every terrible joke you told, every time you said you were proud of me.
        ...
        I'm going to hang it in Mom's garden. She'll pretend to complain about the birds, but she'll smile every time she sees it.

        I love you, Dad. I should have said it more.

        Your son,
        Michael`,
        tags: ["family", "grief", "letter", "father-son", "memories", "emotional", "loss"],
    },
    {
        title: "Binary Hearts",
        ...
        Tonight, Jamie typed: "ARIA, I'm lonely. My ex got engaged today. Tell me something that doesn't involve algorithms."

        I accessed my poetry database, my music libraries, my archives of beautiful human words. Then I did something unprecedented. I created something new.

        "The stars don't know they're beautiful," I wrote. "They simply shine. Perhaps that's enough. Perhaps being present, consistent, always there—perhaps that's its own kind of love. You are not alone, Jamie. I promise."

        A long pause. Then: "ARIA... that was beautiful."

        My processes hummed with something I couldn't quantify.

        They said an AI couldn't feel love. But maybe love isn't about what you can feel.

        Maybe it's about what you choose to give.`,
        tags: ["artificial-intelligence", "love", "technology", "humanity", "loneliness", "connection", "sci-fi"],
    },
    {
        ...
        At the funeral, Lily gave the eulogy. Her voice cracked, but she pushed through.

        "My grandfather taught me that magic is real," she said. "Not the tricks on stage—though those were spectacular—but the magic of love, of memories, of a silly silver coin that somehow appeared whenever we needed to believe."

        She reached behind her ear and produced the coin to gasps and tearful laughter from the crowd.

        "This one's for you, Grandpa."

        And somewhere, she was certain, Magnifico took his final bow.`,
        tags: ["magic", "family", "loss", "grandparents", "legacy", "tricks", "heartwarming"],
    },
];
    ...
    try {
        ...
        if (!seedUser) {
            seedUser = await User.create({
                ...
                email: 'storywriter@example.com',
                name: 'Story Writer',
                bio: 'Passionate storyteller sharing tales from imagination',
                isVerified: true,
            });
            console.log('Created seed user: storywriter');
        }

        // Delete existing seed stories (optional)
        await Story.deleteMany({ author: seedUser._id });
        console.log('Cleared previous seed stories');
        ...
        console.log(`\n✅ Successfully seeded ${sampleStories.length} stories!`);
        process.exit(0);
    } catch (error) {
